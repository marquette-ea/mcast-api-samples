NOTE: This folder is for Windows PowerShell (version 5.x or below, the "powershell.exe" executable). See the PowerShell (7.x+) folder for newer versions of PowerShell (the "pwsh.exe" executable).
